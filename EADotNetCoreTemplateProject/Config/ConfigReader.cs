...
namespace EAAutoFramework.Config
{
    public class ConfigReader
    {
        public static void SetFrameworkSettings()
        {
            ...
            //Settings.IsReporting = configurationRoot.GetSection("testSettings").Get<TestSettings>().TestType;
            ...
            Settings.ErrorMessage = configurationRoot.GetSection("testSettings").Get<TestSettings>().ErrorMessage;
